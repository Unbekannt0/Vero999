...
module.exports = {
 data: new SlashCommandBuilder()
  .setName("embed")
  .setDescription("Generator for an Embed")
  .addStringOption(option =>
    option.setName("title")
    .setDescription("Give a title")
    .setRequired(true)
    )
    .addStringOption(option =>
      option.setName("description")
          .setDescription("Give a description")
          .setRequired(true)
  )
  .addStringOption(option =>
    option.setName("image")
        .setDescription("Give a Image URL")
        .setRequired(true)
)
  .addChannelOption(option =>
  ...
  async execute(client, interaction) {
    ...
    const cch = options.getChannel("channel")
    const ttt = options.getString("title");
    const ddd = options.getString("description");
    const iii = options.getString("image");
